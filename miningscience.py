...
def download_pubmed(keyword):
    """ Esta funcion permite descargar data de Pubmed"""
...
# add a few cities for reference (optional)
    ard = dict(arrowstyle="->")
    plt.annotate('Ghana', xy = (-118.25, 34.05), 
                   xytext = (-108.25, 34.05), arrowprops = ard)
    plt.annotate('China', xy = (-122.1381, 37.4292), 
                   xytext = (-112.1381, 37.4292), arrowprops= ard)
    plt.annotate('India', xy = (-71.1106, 42.3736), 
                   xytext = (-73.1106, 48.3736), arrowprops= ard)
    plt.annotate('Angola', xy = (-87.6847, 41.8369), 
                   xytext = (-87.6847, 46.8369), arrowprops= ard)
    plt.annotate('Rusia', xy = (-122.33, 47.61), 
                   xytext = (-116.33, 47.61), arrowprops= ard)
    plt.annotate('Chad', xy = (-80.21, 25.7753), 
